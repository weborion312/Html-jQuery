...
$(document).ready(function () {
    ...
    $("#cell1").click(function(){
        ...
        $("body,html").stop(true).animate({scrollTop:1950}, 2500, 'easeInOutQuad' );
    ...
    $("#cell2").click(function(){
        ...
        $("body,html").stop(true).animate({scrollTop:5250}, 2500, 'easeInOutQuad' );
         $("#container").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".sroll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $("#roll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".showpro").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
     ...
     $("#cell4").click(function(){
        ...
        $("body,html").stop(true).animate({scrollTop:8250}, 2500, 'easeInOutQuad' );
         $("#container").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".sroll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $("#roll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
         $(".showpro").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
    ...
    $("#cell5").click(function(){
        ...
        $("body,html").stop(true).animate({scrollTop:11250}, 2500, 'easeInOutQuad' );
         $("#container").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".sroll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $("#roll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".showpro").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
    ...
    $("#cell6").click(function(){
        ...
        $("body,html").stop(true).animate({scrollTop:13250}, 2500, 'easeInOutQuad' );
        $("#container").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".sroll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $("#roll").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
        $(".showpro").stop(true).animate({left:"0%"},1000,'easeInOutQuart');
    ...
    $(window).scroll(function(){
          ...
          $("#roll").css("top",unithei+"%");
            ...
            $("#slide7").css("left",left7+"%");
            $("#maskright7").css("left",left7+150+(-0.1)+"%");
        
            $("#slide8").css("left",left8+"%");
            $("#maskright8").css("left",left8+150+(-0.1)+"%");
